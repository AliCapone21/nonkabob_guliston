    ...
    try {
      ...
      const { data: order, error: orderError } = await supabase
        ...
        .insert({
          ...
          user_id: telegramUserId, // ✅ BIGINT FK -> users.telegram_id
        })
        .select()
        .single();
      ...
      // Clear cart (keep your existing context unchanged)
    ...
    return (
      <main className="min-h-screen bg-gray-50 pb-20 flex flex-col">
        ...
        <div className="flex-grow flex flex-col items-center justify-center p-8 text-center">
          ...
          <h2 className="text-xl font-bold text-gray-800 mb-2">Savat hozircha bo'sh</h2>
          <Link
            href="/"
            ...
            <div className="flex flex-col items-end space-y-2">
              <div className="flex items-center bg-gray-100 rounded-lg p-1">
                <button
                  ...
                  className="p-1 bg-white rounded-md shadow-sm text-gray-600"
                >
                  <Minus size={16} />
                </button>
                ...
                <button
                  ...
                  className="p-1 bg-white rounded-md shadow-sm text-green-500"
                >
                  <Plus size={16} />
                </button>
              </div>
